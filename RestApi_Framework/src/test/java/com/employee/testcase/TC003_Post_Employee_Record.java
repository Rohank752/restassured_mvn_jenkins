...
public class TC003_Post_Employee_Record extends TestBase{
	...
	String staus_msg= jsonpath.get("status");
	Assert.assertEquals(staus_msg.contains("success"), true);
	 data_id=Integer.parseInt(jsonpath.getString("data.id"));
	System.out.println("Data Posted Id"+data_id);
